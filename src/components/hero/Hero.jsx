...
export default function Hero() {
  ...
  return <section className="overflow-hidden px-5 py-18 sm:py-24 lg:px-8 lg:py-32"><div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.1fr_.9fr]"><motion.div {...entrance}><p className="mb-5 text-xs font-bold uppercase tracking-[.22em] text-accent">Social media, elevated</p><h1 className="max-w-3xl text-5xl font-semibold leading-[.98] tracking-[-.05em] sm:text-7xl">We make brands impossible to <span className="text-accent">ignore.</span></h1><p className="mt-7 max-w-xl text-lg leading-8 text-secondary">Elevate Digital partners with ambitious brands to create culture-shaping social experiences and measurable growth.</p><Button to="/contact" className="mt-8">Start a conversation</Button></motion.div><motion.div {...visualEntrance} aria-hidden="true" className="relative mx-auto aspect-square w-full max-w-md rounded-[2rem] bg-gradient-to-br from-primary via-[#60A5FA] to-accent p-5" /></div></section>
}